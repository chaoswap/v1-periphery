import { abi as IChaoswapV1PoolABI } from '@chaoswap/v1-core/artifacts/contracts/interfaces/IChaoswapV1Pool.sol/IChaoswapV1Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { IChaoswapV1Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [IChaoswapV1Pool, IChaoswapV1Pool, IChaoswapV1Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, IChaoswapV1PoolABI, wallet)) as [
      IChaoswapV1Pool,
      IChaoswapV1Pool,
      IChaoswapV1Pool
    ]
  ...
  let pools: [IChaoswapV1Pool, IChaoswapV1Pool, IChaoswapV1Pool]
  ...
  describe('#exactInput', () => {
    ...
    it('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestChaoswapV1Callee')
