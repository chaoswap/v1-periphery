...
import { abi as PAIR_V2_ABI } from '@chaoswap/v2-core/build/chaoswapV2Pair.json'
...
describe('V3Migrator', () => {
  ...
  let factoryV3: IChaoswapV1Factory
  let token: TestERC20
  let weth9: IWETH9
  let nft: MockTimeNonfungiblePositionManager
  let migrator: V3Migrator
  let pair: IchaoswapV2Pair
  ...
  beforeEach('add V2 liquidity', async () => {
    ...
    pair = new ethers.Contract(pairAddress, PAIR_V2_ABI, wallet) as IchaoswapV2Pair
