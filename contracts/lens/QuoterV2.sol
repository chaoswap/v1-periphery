...
import '@chaoswap/v1-core/contracts/libraries/SafeCast.sol';
import '@chaoswap/v1-core/contracts/libraries/TickMath.sol';
import '@chaoswap/v1-core/contracts/libraries/TickBitmap.sol';
import '@chaoswap/v1-core/contracts/interfaces/IChaoswapV1Pool.sol';
import '@chaoswap/v1-core/contracts/interfaces/callback/IChaoswapV1SwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IChaoswapV1SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IChaoswapV1Pool) {
        return IChaoswapV1Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IChaoswapV1SwapCallback
    function ChaoswapV1SwapCallback(
        ...
        IChaoswapV1Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IChaoswapV1Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
