...
import '@chaoswap/v1-core/contracts/interfaces/callback/IChaoswapV1FlashCallback.sol';
import '@chaoswap/v1-core/contracts/libraries/LowGasSafeMath.sol';
...
/// @notice An example contract using the chaoswap V3 flash function
contract PairFlash is IChaoswapV1FlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `ChaoswapV1FlashCallback`
    function initFlash(FlashParams memory params) external {
        PoolAddress.PoolKey memory poolKey =
            PoolAddress.PoolKey({token0: params.token0, token1: params.token1, fee: params.fee1});
        IChaoswapV1Pool pool = IChaoswapV1Pool(PoolAddress.computeAddress(factory, poolKey));
